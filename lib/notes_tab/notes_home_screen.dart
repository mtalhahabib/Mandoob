...
import 'package:web_project/notes_tab/calendar_popup_view.dart';
import 'package:web_project/notes_tab/eventNotes.dart';
import 'package:web_project/notes_tab/notes_list_view.dart';
import 'package:web_project/notes_tab/model/hotel_list_data.dart';
import 'filters_screen.dart';
import 'notes_app_theme.dart';
                                  ...
                                  child: Padding(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        ...
                                        color:
                                            Color.fromARGB(255, 252, 197, 135),
                                      ),
                                      child: Column(
                                        children: <Widget>[
                                          getSearchBarUI(),
        ...
        children: <Widget>[
          Expanded(
            child: Padding(
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: NotesAppTheme().backgroundColor,
                  borderRadius: const BorderRadius.all(
